...
export enum CosmeticOption {
     ...
     */
    CosmeticOptionSourceGenericCSS = 1 << 6,
    CosmeticOptionSourceCSS = 1 << 7,
    CosmeticOptionSourceJS = 1 << 8,

    /**
     * everything is enabled
     */
    CosmeticOptionAll = CosmeticOptionCSS
